...
static const struct snd_kcontrol_new rx5_usb_mix1_inp1_mux =
	SOC_DAPM_ENUM("RX5_USB MIX1 INP1 Mux", rx5_mix1_inp1_chain_enum);

static const struct snd_kcontrol_new rx6_usb_mix1_inp1_mux =
	SOC_DAPM_ENUM("RX6_USB MIX1 INP1 Mux", rx6_mix1_inp1_chain_enum);
...
static const struct snd_kcontrol_new rx6_usb_dsm_mux =
	SOC_DAPM_ENUM("RX6_USB DSM MUX Mux", rx6_dsm_enum);
...
static const struct snd_soc_dapm_widget tabla_dapm_widgets[] = {
	...
	SND_SOC_DAPM_PGA_E("LINEOUT5 PA", TABLA_A_RX_LINE_CNP_EN, 4, 0, NULL, 0,
		...
		SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_PGA_E("LINEOUT2_USB PA", SND_SOC_NOPM, 1, 0, NULL, 0, NULL, 0),
	SND_SOC_DAPM_PGA_E("LINEOUT4_USB PA", SND_SOC_NOPM, 3, 0, NULL, 0, NULL, 0),
...
// hTC: keep for TABLA ES sample
	...
	SND_SOC_DAPM_DAC_E("LINEOUT5 DAC", NULL, TABLA_A_RX_LINE_5_DAC_CTL, 7, 0
		, tabla_lineout_dac_event,
		SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_DAC_E("LINEOUT2_USB DAC", NULL, TABLA_A_RX_LINE_2_DAC_CTL, 7, 0
		, tabla_lineout_dac_event,
		SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_DAC_E("LINEOUT4_USB DAC", NULL, TABLA_A_RX_LINE_4_DAC_CTL, 7, 0
                , tabla_lineout_dac_event,
                SND_SOC_DAPM_PRE_PMU | SND_SOC_DAPM_POST_PMD),
	...
	SND_SOC_DAPM_MIXER_E("RX5_USB MIX1", SND_SOC_NOPM, 4, 0, NULL,
		0, NULL, 0),
	SND_SOC_DAPM_MIXER_E("RX6_USB MIX1", SND_SOC_NOPM, 5, 0, NULL,
		0, NULL, 0),
	SND_SOC_DAPM_MUX_E("RX6_USB DSM MUX", SND_SOC_NOPM, 5, 0,
		&rx6_usb_dsm_mux, NULL, 0),
	...
	SND_SOC_DAPM_MUX("RX7 MIX1 INP2", SND_SOC_NOPM, 0, 0,
		&rx7_mix1_inp2_mux),
	SND_SOC_DAPM_MUX("RX5_USB MIX1 INP1", SND_SOC_NOPM, 0, 0,
		&rx5_usb_mix1_inp1_mux),
	SND_SOC_DAPM_MUX("RX6_USB MIX1 INP1", SND_SOC_NOPM, 0, 0,
		&rx6_usb_mix1_inp1_mux),
	...
	SND_SOC_DAPM_SUPPLY("RX_USB_BIAS", SND_SOC_NOPM, 0, 0, NULL, 0),
...
static const struct snd_soc_dapm_route audio_map[] = {
	...
	{"LINEOUT2", NULL, "LINEOUT2_USB PA"},
	{"LINEOUT4", NULL, "LINEOUT4_USB PA"},
	...
	{"LINEOUT2_USB PA", NULL, "LINEOUT2_USB DAC"},
	{"LINEOUT4_USB PA", NULL, "LINEOUT4_USB DAC"},
	...
	{"LINEOUT2_USB DAC", NULL, "RX_USB_BIAS"},
	{"LINEOUT4_USB DAC", NULL, "RX_USB_BIAS"},
	...
	{"RX5_USB MIX1", NULL, "RX5_USB MIX1 INP1"},
	{"RX6_USB MIX1", NULL, "RX6_USB MIX1 INP1"},
	...
	{"RX5_USB MIX1 INP1","RX1","SLIM RX1"},
	{"RX5_USB MIX1 INP1","RX2","SLIM RX2"},
	{"RX5_USB MIX1 INP1","RX3","SLIM RX3"},
	{"RX5_USB MIX1 INP1","RX4","SLIM RX4"},
	{"RX6_USB MIX1 INP1","RX1","SLIM RX1"},
	{"RX6_USB MIX1 INP1","RX2","SLIM RX2"},
	{"RX6_USB MIX1 INP1","RX3","SLIM RX3"},
	{"RX6_USB MIX1 INP1","RX4","SLIM RX4"},
...
static const struct snd_soc_dapm_route tabla_2_x_lineout_2_to_4_map[] = {
	...
	{"LINEOUT2_USB DAC", NULL, "RX5_USB MIX1"},

	{"RX6 DSM MUX", "DSM_INV", "RX5 MIX1"},
	{"RX6 DSM MUX", "CIC_OUT", "RX6 MIX1"},
	{"RX6_USB DSM MUX", "DSM_INV", "RX5_USB MIX1"},
	{"RX6_USB DSM MUX", "CIC_OUT", "RX6_USB MIX1"},

	{"LINEOUT4 DAC", NULL, "RX6 DSM MUX"},
	{"LINEOUT4_USB DAC", NULL, "RX6_USB DSM MUX"},
};
